...
class Circle(Point):
    ...
    def perimetr_s_cirkle(self):
        perimetr = 2 * 3.14 * self.r
        s_circle = 3.14 * (self.r ** 2)
        return perimetr, s_circle
...
class Triangle(Point):
    ...
    def perimetr_s_triangle(self):
        ...
        s_triangle = (0.5 * perimetr * (
                    (0.5 * perimetr - a_b) * (0.5 * perimetr - b_c) * (0.5 * perimetr - a_c))) ** 0.5
...
def main():
    circle = Circle(3, 2, 5)
    print(circle.perimetr_s_cirkle())

    triangle = Triangle(1, 1, 3, 4, 6, 2)
    print(triangle.perimetr_s_triangle())

    square = Square(1, 2, 4, 6)
